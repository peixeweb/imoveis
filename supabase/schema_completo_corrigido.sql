-- Supabase Schema Fix Completo — ImobiFlow
-- Execute este SQL no SQL Editor do Supabase Dashboard
-- https://supabase.com/dashboard/project/YOUR_PROJECT_ID/sql

-- ============================================
-- REMOVA POLÍTICAS ANTIGAS (para reiniciar limpo)
-- ============================================
...
-- ============================================
-- POLÍTICAS CORRIGIDAS (sem recursão infinita)
-- ============================================
...
-- Políticas para corretores (permite ver corretores da mesma equipe)
